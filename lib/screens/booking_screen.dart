                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('Booking for: ${service.category}', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                        SizedBox(height: 16),
                        ListTile(
                        ...
                        ElevatedButton.icon(
                          ...
                          onPressed: () async {
                            ...
                            var box = await Hive.openBox<Booking>(HiveBoxes.bookingBox);
                        ...
                        ElevatedButton.icon(
                          ...
                          onPressed: () async {
                            ...
                            var box = await Hive.openBox<Booking>(HiveBoxes.bookingBox);
                            await box.put(booking.bookingId, booking);
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Booking marked as dispute!')));
                            Navigator.pop(context);
                          },
